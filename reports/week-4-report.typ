...
// Week Period: Mar 23 - Mar 29, 2026
// SHA: 4e13f43
...
#set page(
  ...
  footer: [
    #place(
      ...
      dx: 5pt,
      dy: -8pt,
      text(size: 7pt, fill: gray)[Generated 2026-03-29 · SHA: 4e13f43 · model: qwen3.5:2b]
    )
    #place(
      bottom + right,
      dx: -45pt,
...
#report_header("1")
#section_title("1", "Week 4", "Weekly Progress Report")
...
#box(width: 100%, inset: 12pt, fill: muted_bg, radius: 4pt, [
  ...
  #grid(columns: (auto, 1fr, auto), gutter: 10pt, [
    #text(size: 9pt)[*Report Date:* March 29, 2026]
    #h(1fr)
    #text(size: 9pt)[*Week Period:* Mar 23 - Mar 29, 2026]
  ])
])
...
#box(width: 100%, inset: 15pt, fill: muted_bg.lighten(50%), radius: 4pt, [
  #text(size: 9pt)[
    Week 4 progress: 0 of 14 tasks completed (0%).
...
#box(width: 100%, inset: 15pt, fill: chapter_themes.at("3").accent.lighten(90%), radius: 4pt, [
  #text(size: 9pt)[
    These tasks were planned for Week 4 and successfully completed:
  ]
])
...
#box(width: 100%, inset: 15pt, fill: chapter_themes.at("2").accent.lighten(90%), radius: 4pt, [
  #text(size: 9pt)[
    These tasks were planned for Week 4 but remain incomplete:
  ]
])
...
#box(width: 100%, fill: muted_bg.lighten(50%), inset: 10pt, radius: 4pt, [
  #text(size: 10pt, weight: "bold")[#147 - Document - Before/after video]
  #v(2pt) #text(size: 8pt, fill: gray)[ | Time: 30 min | Date: April 2 AM...]
])
#v(4pt)

#box(width: 100%, fill: muted_bg.lighten(50%), inset: 10pt, radius: 4pt, [
  #text(size: 10pt, weight: "bold")[#146 - Test - G-code over Wi-Fi]
  #v(2pt) #text(size: 8pt, fill: gray)[ | Time: 30 min | Date: April 2 AM...]
])
#v(4pt)

#box(width: 100%, fill: muted_bg.lighten(50%), inset: 10pt, radius: 4pt, [
  #text(size: 10pt, weight: "bold")[#145 - Config - Set up Wi-Fi in FluidNC]
  #v(2pt) #text(size: 8pt, fill: gray)[ | Time: 30 min | Date: April 1 AM...]
])
#v(4pt)

#box(width: 100%, fill: muted_bg.lighten(50%), inset: 10pt, radius: 4pt, [
  #text(size: 10pt, weight: "bold")[#144 - Test - Stability test (3 cycles)]
  #v(2pt) #text(size: 8pt, fill: gray)[ | Time: 30 min | Date: April 1 AM...]
])
#v(4pt)

#box(width: 100%, fill: muted_bg.lighten(50%), inset: 10pt, radius: 4pt, [
  #text(size: 10pt, weight: "bold")[#143 - Backup - Commit config to GitHub]
  #v(2pt) #text(size: 8pt, fill: gray)[ | Time: 30 min | Date: April 1 AM...]
])
#v(4pt)

#box(width: 100%, fill: muted_bg.lighten(50%), inset: 10pt, radius: 4pt, [
  #text(size: 10pt, weight: "bold")[#142 - Document - Add comments to config.yaml]
  #v(2pt) #text(size: 8pt, fill: gray)[ | Time: 30 min | Date: March 31 AM...]
])
#v(4pt)

#box(width: 100%, fill: muted_bg.lighten(50%), inset: 10pt, radius: 4pt, [
  #text(size: 10pt, weight: "bold")[#141 - Document - Record calibration values]
  #v(2pt) #text(size: 8pt, fill: gray)[ | Time: 30 min | Date: March 31 AM...]
])
#v(4pt)

#box(width: 100%, fill: muted_bg.lighten(50%), inset: 10pt, radius: 4pt, [
  #text(size: 10pt, weight: "bold")[#140 - Document - Photograph first drawings]
  #v(2pt) #text(size: 8pt, fill: gray)[ | Time: 30 min | Date: March 31 AM...]
])
#v(4pt)

#box(width: 100%, fill: muted_bg.lighten(50%), inset: 10pt, radius: 4pt, [
  #text(size: 10pt, weight: "bold")[#139 - Test - Complex G-code file]
  #v(2pt) #text(size: 8pt, fill: gray)[ | Time: 30 min | Date: March 30 AM...]
])
#v(4pt)

#box(width: 100%, fill: muted_bg.lighten(50%), inset: 10pt, radius: 4pt, [
  #text(size: 10pt, weight: "bold")[#138 - Adjust - Acceleration fine-tuning]
  #v(2pt) #text(size: 8pt, fill: gray)[ | Time: 30 min | Date: March 30 AM...]
])
#v(4pt)

#box(width: 100%, fill: muted_bg.lighten(50%), inset: 10pt, radius: 4pt, [
  #text(size: 10pt, weight: "bold")[#137 - Adjust - Backlash compensation]
  #v(2pt) #text(size: 8pt, fill: gray)[ | Time: 30 min | Date: March 30 AM...]
])
#v(4pt)

#box(width: 100%, fill: muted_bg.lighten(50%), inset: 10pt, radius: 4pt, [
  #text(size: 10pt, weight: "bold")[#136 - Test - Draw straight lines]
  #v(2pt) #text(size: 8pt, fill: gray)[ | Time: 30 min | Date: March 30 AM...]
])
#v(4pt)
