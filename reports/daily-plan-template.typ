...
// Auto-generated by GitHub Actions every day at 00:00
    ...
    [
      #grid(
        ...
        align(top + right, [
          ...
          #v(8pt)
          #text(size: 14pt, weight: "bold", fill: chapter_themes.at("1").accent)[##issue.number]
        ])
      )
...
#let stats_row(stats) = {
  #grid(
    ...
    box(
      ...
      radius: 4pt,
      align(center, [
        #text(size: 20pt, weight: "bold", fill: chapter_themes.at("1").accent)[#stats.total]
    ...
    box(
      ...
      radius: 4pt,
      align(center, [
        #text(size: 20pt, weight: "bold", fill: chapter_themes.at("2").accent)[#stats.high_priority]
    ...
    box(
      ...
      radius: 4pt,
      align(center, [
        #text(size: 20pt, weight: "bold", fill: chapter_themes.at("3").accent)[#stats.milestones]
...
#section_title("1", f"{plan_date.day:02}/{plan_date.month:02}", "Daily Plan")
...
#box(
  ...
  [
    #text(size: 9pt, fill: gray, style: "italic")[
      ...
      \
      Example:
      - Complete issue #12 (Generative AI Pipeline)
      - Test OSC communication with TouchDesigner
      - Document plotter calibration results
    ]
  ]
)
