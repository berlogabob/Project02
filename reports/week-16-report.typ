...
// Week Period: Jun 15 - Jun 21, 2026
// SHA: 7bdae95
...
#set page(
  ...
  footer: [
    #place(
      ...
      dx: 5pt,
      dy: -8pt,
      text(size: 7pt, fill: gray)[Generated 2026-06-21 · SHA: 7bdae95 · model: qwen3.5:2b]
    )
    #place(
      bottom + right,
      dx: -45pt,
...
#report_header("1")
#section_title("1", "Week 16", "Weekly Progress Report")
...
#box(width: 100%, inset: 12pt, fill: muted_bg, radius: 4pt, [
  ...
  #grid(columns: (auto, 1fr, auto), gutter: 10pt, [
    #text(size: 9pt)[*Report Date:* June 21, 2026]
    #h(1fr)
    #text(size: 9pt)[*Week Period:* Jun 15 - Jun 21, 2026]
  ])
])
...
#box(width: 100%, inset: 15pt, fill: muted_bg.lighten(50%), radius: 4pt, [
  #text(size: 9pt)[
    Week 16 progress: 0 of 0 tasks completed (0%).
...
#box(width: 100%, inset: 15pt, fill: chapter_themes.at("3").accent.lighten(90%), radius: 4pt, [
  #text(size: 9pt)[
    These tasks were planned for Week 16 and successfully completed:
  ]
])
...
#box(width: 100%, inset: 15pt, fill: chapter_themes.at("2").accent.lighten(90%), radius: 4pt, [
  #text(size: 9pt)[
    These tasks were planned for Week 16 but remain incomplete:
  ]
])
