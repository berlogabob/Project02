...
#set page(
  ...
  footer: [
    #place(
      ...
      dx: 5pt,
      dy: -8pt,
      text(size: 7pt, fill: gray)[Generated 2026-08-31 · SHA: 12c2481 · model: qwen3.5:2b]
    )
    #place(
      bottom + right,
      dx: -45pt,
...
#report_header("1")
#section_title("1", "Week 27", "Weekly Progress Report")
...
#box(width: 100%, inset: 15pt, fill: muted_bg.lighten(50%), radius: 4pt, [
  #text(size: 9pt)[
    Week 27 progress: 0 of 0 tasks completed (0%).
...
#box(width: 100%, inset: 15pt, fill: chapter_themes.at("3").accent.lighten(90%), radius: 4pt, [
  #text(size: 9pt)[
    These tasks were planned for Week 27 and successfully completed:
  ]
])
...
#box(width: 100%, inset: 15pt, fill: chapter_themes.at("2").accent.lighten(90%), radius: 4pt, [
  #text(size: 9pt)[
    These tasks were planned for Week 27 but remain incomplete:
  ]
])
