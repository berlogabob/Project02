...
#let stats_box() = {
  grid(columns: (1fr, 1fr, 1fr), gutter: 15pt,
    ...
    box(fill: chapter_themes.at("2").accent.lighten(90%), inset: 12pt, radius: 4pt, align(center, [
      text(size: 20pt, weight: "bold", fill: chapter_themes.at("2").accent)[16]
...
#box(width: 100%, inset: 15pt, fill: muted_bg.lighten(50%), radius: 4pt, [
  #text(size: 9pt)[
    Week 2 progress: 0 of 16 tasks completed (0%).
...
#text(size: 8pt, fill: gray)[0% complete]
...
#box(width: 100%, inset: 10pt, fill: muted_bg.lighten(50%), radius: 4pt, [
  #text(size: 11pt, weight: "bold")[#35 - #14 - Deep Learning Model Selection & Dataset Prep] #text(size: 9pt, fill: red, weight: "bold")[HIGH]
  #v(4pt) #text(size: 8pt, fill: gray)[Milestone: 2nd milestone: Prototype]
  #v(4pt) #text(size: 8pt, fill: gray)[Week 2]
])
#v(8pt)
...
#box(width: 100%, inset: 10pt, fill: muted_bg.lighten(50%), radius: 4pt, [
  #text(size: 11pt, weight: "bold")[#34 - #13 - Agentic AI Loop Implementation]
  #v(4pt) #text(size: 8pt, fill: gray)[Milestone: 2nd milestone: Prototype]
  #v(4pt) #text(size: 8pt, fill: gray)[Week 2]
])
#v(8pt)
...
#box(width: 100%, inset: 10pt, fill: muted_bg.lighten(50%), radius: 4pt, [
  #text(size: 11pt, weight: "bold")[#33 - #12 - Generative AI Pipeline Development]
  #v(4pt) #text(size: 8pt, fill: gray)[Milestone: 2nd milestone: Prototype]
  #v(4pt) #text(size: 8pt, fill: gray)[Week 2]
])
#v(8pt)
...
#box(width: 100%, inset: 10pt, fill: muted_bg.lighten(50%), radius: 4pt, [
  #text(size: 11pt, weight: "bold")[#32 - #11 - TouchDesigner Integration Setup] #text(size: 9pt, fill: red, weight: "bold")[HIGH]
  #v(4pt) #text(size: 8pt, fill: gray)[Milestone: 2nd milestone: Prototype]
  #v(4pt) #text(size: 8pt, fill: gray)[Week 2]
])
#v(8pt)
...
#box(width: 100%, inset: 10pt, fill: muted_bg.lighten(50%), radius: 4pt, [
  #text(size: 11pt, weight: "bold")[#31 - #10 - Unity Project Setup]
  #v(4pt) #text(size: 8pt, fill: gray)[Milestone: 2nd milestone: Prototype]
  #v(4pt) #text(size: 8pt, fill: gray)[Week 2]
])
#v(8pt)
