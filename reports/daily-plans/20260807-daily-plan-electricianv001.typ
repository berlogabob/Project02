...
#section_title("1", "Week 23: August 07", "Daily Plan")
...
#table(
  ...
  [#block(radius: 4pt, inset: 12pt)[#align(center, [#text(size: 20pt, weight: "bold", fill: chapter_themes.at("3").accent)[August 07] #text(size: 8pt)[Date]])]]
)
