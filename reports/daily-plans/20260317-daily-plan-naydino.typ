...
#section_title("1", "Week 3: March 17", "Daily Plan")
...
#table(
  ...
  [#block(radius: 4pt, inset: 12pt)[#align(center, [#text(size: 20pt, weight: "bold", fill: chapter_themes.at("3").accent)[March 17] #text(size: 8pt)[Date]])]]
)
...
#issue_card(155, [UX phase 1 research], "", [ ...], [None], [week-3, Next-Week-Preview])

#issue_card(155, [UX phase 1 research], "", [ ...], [None], [week-3, Next-Week-Preview])

#issue_card(56, [Oracle output based on user interaction], "", [ ...], [None], [type: testing, week-3, week-4, show-in-report, Next-Week-Preview])
...
#issue_card(48, [Test and compare speech to text models inside of TD], "", [test https://github.com/KittenML/KittenTTS ...], [None], [type: testing, week-3, show-in-report, Next-Week-Preview])
