// Daily Plan - Nadine Allan - 20260305
#set page(paper: "a4", margin: 50pt)
#set text(size: 10pt)
#let blue = rgb("#2F80ED")

#align(center)[#text(size: 20pt, fill: blue, bold: true)[📅 Daily Plan]]
#align(center)[#text(size: 16pt)[05/03]]
#align(center)[#text(size: 14pt)[Nadine Allan]]

#line(length: 100%)

#text(size: 12pt, bold: true)[Tasks: 6]
