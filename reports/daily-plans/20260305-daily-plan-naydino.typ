...
#grid(
  ...
  #box(
    ...
    radius: 4pt,
    align(center, [
      #text(size: 20pt, weight: "bold", fill: chapter_themes.at("1").accent)[6]
...
#issue_card(#7, [TD Test: "Can TD push that text out (on-screen now; Unity later if needed)?"], "", [], [], [])
...
#issue_card(#3, [Define characteristics of AI Oracle], "", [], [], [])
