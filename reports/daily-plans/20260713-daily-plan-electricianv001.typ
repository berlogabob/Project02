...
#section_title("1", "Week 20: July 13", "Daily Plan")
...
#table(
  ...
  [#block(radius: 4pt, inset: 12pt)[#align(center, [#text(size: 20pt, weight: "bold", fill: chapter_themes.at("3").accent)[July 13] #text(size: 8pt)[Date]])]]
)
