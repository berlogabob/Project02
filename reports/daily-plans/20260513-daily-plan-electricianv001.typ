...
#section_title("1", "Week 11: May 13", "Daily Plan")
...
#table(
  ...
  [#block(radius: 4pt, inset: 12pt)[#align(center, [#text(size: 20pt, weight: "bold", fill: chapter_themes.at("3").accent)[May 13] #text(size: 8pt)[Date]])]]
)
